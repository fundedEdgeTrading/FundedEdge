...
/// </summary>
/// <param name="AiModelId">Id de modelo Anthropic (wire format, ej. "claude-haiku-4-5") — este proyecto no depende del SDK de Anthropic, el mapeo a su enum vive en TrackRecord.Infrastructure.Ai.</param>
    ...
    bool CanPublishPublicProfile)
{
    public static PlanLimits For(PlanTier tier) => tier switch
    {
        PlanTier.Starter => new PlanLimits(
            ...
            CanExportPdf: false, CanPublishPublicProfile: false),
        PlanTier.Pro => new PlanLimits(
            ...
            CanExportPdf: true, CanPublishPublicProfile: false),
        PlanTier.Elite => new PlanLimits(
            ...
            CanExportPdf: true, CanPublishPublicProfile: true),
