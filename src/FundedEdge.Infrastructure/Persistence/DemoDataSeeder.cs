...
using FundedEdge.Domain.Trades;
    ...
    ILogger<DemoDataSeeder> logger)
{
    ...
    private static List<Trade> AddTrades(
        FundedEdgeDbContext db, TradingAccount account, int seed, int count,
    ...
    private static void SeedPsychology(FundedEdgeDbContext db, string userId, DateOnly today, List<Trade> recentTrades)
    {
