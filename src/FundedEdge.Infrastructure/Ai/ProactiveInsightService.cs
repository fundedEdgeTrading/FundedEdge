    ...
    ILogger<ProactiveInsightService> logger) : BackgroundService
{
    ...
    private async Task CheckLosingStreakAsync(FundedEdgeDbContext db, ITradingAnalystService analyst, string userId, CancellationToken ct)
    {
    ...
    private async Task CheckDrawdownRiskAsync(AsyncServiceScope scope, FundedEdgeDbContext db, ITradingAnalystService analyst, string userId, CancellationToken ct)
    {
    ...
    private async Task CheckFirstPayoutAsync(FundedEdgeDbContext db, ITradingAnalystService analyst, string userId, CancellationToken ct)
    {
    ...
    private async Task<bool> WasRecentlyGeneratedAsync(FundedEdgeDbContext db, string userId, AiReportKind kind, TimeSpan cooldown, CancellationToken ct)
    {
