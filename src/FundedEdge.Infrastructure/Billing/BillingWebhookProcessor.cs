...
/// </summary>
public class BillingWebhookProcessor(IDbContextFactory<FundedEdgeDbContext> dbFactory, ILogger<BillingWebhookProcessor> logger)
{
    ...
    private async Task ApplyCheckoutCompletedAsync(FundedEdgeDbContext db, BillingWebhookEvent evt, CancellationToken ct)
    {
    ...
    private async Task DowngradeByCustomerIdAsync(FundedEdgeDbContext db, string? customerId, CancellationToken ct)
    {
