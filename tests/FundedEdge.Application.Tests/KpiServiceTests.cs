...
/// </summary>
public sealed class InMemoryDbContextFactory(string databaseName) : IDbContextFactory<FundedEdgeDbContext>
{
    public FundedEdgeDbContext CreateDbContext()
    {
        var options = new DbContextOptionsBuilder<FundedEdgeDbContext>()
            .UseInMemoryDatabase(databaseName)
            .Options;
        return new FundedEdgeDbContext(options);
    }

    public Task<FundedEdgeDbContext> CreateDbContextAsync(CancellationToken cancellationToken = default)
